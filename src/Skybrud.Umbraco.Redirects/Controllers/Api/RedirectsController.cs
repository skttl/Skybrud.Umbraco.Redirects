...
namespace Skybrud.Umbraco.Redirects.Controllers.Api {
    ...
    public class RedirectsController : UmbracoAuthorizedApiController {
        ...
        [HttpGet]
        public object AddRedirect(int rootNodeId, string url, string linkMode, int linkId, string linkUrl, string linkName = null, bool isRegex = false, bool forwardQueryString = false) {
            ...
            try {
                ...
                return Repository.AddRedirect(rootNodeId, url, redirect, isRegex, forwardQueryString);
        ...
        [HttpGet]
        public object EditRedirect(int rootNodeId, string redirectId, string url, string linkMode, int linkId, string linkUrl, string linkName = null, bool isRegex = false, bool forwardQueryString = false) {
